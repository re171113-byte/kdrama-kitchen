---
title: "Reply 1988 Sundae - The Street Food That Brings Back Memories"
description: "Learn to make Korean blood sausage sundae, the nostalgic street food from Reply 1988 that captures the warmth of 1980s Seoul."
pubDate: "2026-02-04"
...
<ul class="recipe-list">
  <li class="recipe-item">
    <span>
      <span class="item-name">Pig intestine casing</span>
      <span class="item-note">(or substitute with sausage casing)</span>
    </span>
    <a href="https://www.amazon.com/s?k=natural+hog+casing+sausage&tag=kdramacitchen-20" class="buy-btn" target="_blank" rel="nofollow noopener">Amazon →</a>
  </li>
  <li class="recipe-item">
    <span>
      <span class="item-name">Korean glass noodles (dangmyeon)</span>
      <span class="item-note">(200g, soaked and cut)</span>
    </span>
  ...
  <li class="recipe-item">
    <span class="item-name">Pig's blood (200g) or substitute with firm tofu</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">2 cups cooked glutinous rice</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">1 cup bean sprouts, blanched and chopped</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">1/2 cup green onions, finely chopped</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">3 cloves garlic, minced</span>
  </li>
  <li class="recipe-item">
...
<ul class="recipe-list">
  <li class="recipe-item">
    <span class="item-name">2 tablespoons coarse sea salt</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">1/2 teaspoon black pepper</span>
  </li>
...
<ul class="recipe-list">
  <li class="recipe-item">
    <span>
      <span class="item-name">Steamer or large pot with steaming rack</span>
    </span>
  </li>
  <li class="recipe-item">
    <span class="item-name">Kitchen twine</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">Large mixing bowl</span>
  </li>
  <li class="recipe-item">
    <span class="item-name">Funnel or piping bag (for stuffing)</span>
  </li>
</ul>
...
1. Cook 200g glass noodles according to package directions
2. Stir-fry with crumbled firm tofu, bean sprouts, and green onions
3. Season with sesame oil, soy sauce, salt, and pepper
4. Serve with the traditional salt-pepper dip
...
오늘 밤, *응답하라 1988*을 보면서 직접 만든 순대와 함께하는 건 어떨까요?
